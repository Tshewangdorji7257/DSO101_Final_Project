...
import { Eye, EyeOff, ArrowRight, Mail, Lock, PenLine } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Sign in to continue your journey of words and ideas.
            </p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/10 via-accent/10 to-primary/5 items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          />
          <blockquote className="font-serif text-2xl text-foreground/80 leading-relaxed mb-6">
